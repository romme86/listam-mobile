#!/usr/bin/env node
// Generates packages/grocery/category-translations.mjs from assets/data/grocery_categories_translated.csv
...
const outPath = path.join(__dirname, '../packages/grocery/category-translations.mjs')
...
const output = `// AUTO-GENERATED by scripts/generate-category-lookup.mjs — do not edit manually
// Source: assets/data/grocery_categories_translated.csv

export const SUPPORTED_LANGS = ${JSON.stringify(LANGS)}
