#!/usr/bin/env node
// Generates packages/grocery/item-translations.mjs from assets/data/grocery_categories_translated.csv
...
const outPath = path.join(__dirname, '../packages/grocery/item-translations.mjs')
...
const output = `// AUTO-GENERATED by scripts/generate-item-translations.mjs — do not edit manually
